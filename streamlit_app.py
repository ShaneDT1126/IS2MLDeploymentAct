...
with c1:
    st.info('**GitHub:[@ShaneDT1126](https://github.com/anilremo23)**', icon="🧠")
with c2:
    st.info('**Kaggle:[@Shane Dela Torre](https://www.kaggle.com/shanedelatorre)**', icon="💻")
with c3:
    st.info('**LinkedIn:[@Jun Cyric Shane Dela Torre](https://www.linkedin.com/in/jun-cyric-shane-dela-torre-0b1041268/)**', icon="👨‍💼")
